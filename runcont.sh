...
docker run -it --network=host --env DISPLAY=127.0.0.1:0 --privileged --volume="$HOME/.Xauthority:/root/.Xauthority:rw" \
-v /tmp/.X11-unix:/tmp/.X11-unix \
-v /home/chris/ros_vnc/mysource:/mysource \
-v /home/chris/ros_vnc:/ros_vnc \
--ipc=host --rm myros2
